    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl py-8 sm:py-10">
          <div className="grid gap-7 border-b border-white/10 pb-7 md:grid-cols-[minmax(0,1fr)_minmax(190px,auto)_auto] md:items-end">
            <div>
            ...
            <div>
              <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-[#d4af37]">Informations légales</h2>
              <nav aria-label="Informations légales" className="mt-3 flex flex-col items-start gap-2 text-sm text-zinc-300">
                <Link href="/cgu" className="transition hover:text-[#d4af37]">Conditions Générales d’Utilisation</Link>
                <Link href="/politique-confidentialite" className="transition hover:text-[#d4af37]">Politique de confidentialité</Link>
                <Link href="/mentions-legales" className="transition hover:text-[#d4af37]">Mentions légales</Link>
                <Link href="/livraison-retours" className="transition hover:text-[#d4af37]">Livraison et retours</Link>
              </nav>
            </div>
            <nav aria-label="Boutique et réseaux sociaux" className="flex flex-col items-start gap-2 text-sm font-bold">
